// Importamos fragment para la estructura del header
import { Fragment } from "react";

// Importamos popover para el menú de usuario
// Importamos transition para la animación del menú
// Importamos menu para el menú
import { Popover, Transition, Menu } from "@headlessui/react";

// Importamos Bars3Icon para el icono de menú
import { Bars3Icon } from "@heroicons/react/24/outline";
import { AiFillHome, AiFillPlusSquare } from "react-icons/ai";

// Creamos una funcion para almacenar las clases de los links
function classNames(...classes) {
  return classes.filter(Boolean).join(" ");
}

// Creamos y exportamos por defecto el componente Header
